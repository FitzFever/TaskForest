 ...
 */
export async function getTreeHealth(req, res) {
    try {
        const { id } = req.params;
        if (!id) {
 ...
 */
export async function updateTreeHealth(req, res) {
    try {
        const { id } = req.params;
 ...
 */
export async function getTaskTreeHealth(req, res) {
    try {
        const { id } = req.params;
        if (!id) {
            return res.status(400).json({
 ...
 */
export async function batchUpdateTreesHealth(req, res) {
    try {
...
//# sourceMappingURL=treeHealthController.js.map