...
export class TaskAnalysisController {
    constructor() {
         ...
         * @param res 响应对象
         */
        this.analyzeTaskComplexity = async (req, res) => {
            try {
         ...
         * @param res 响应对象
         */
        this.decomposeTask = async (req, res) => {
            try {
                const request = req.body;
                // 验证请求
                ...
                res.status(500).json({ error: `拆解任务失败: ${error.message}` });
            }
        };
        this.deepseekService = new DeepSeekService();
    }
}
//# sourceMappingURL=taskAnalysisController.js.map