...
import { HealthCategory } from '../types/treeHealth.js';
...
export class TreeHealthService {
     ...
     */
    async updateTreeHealth(treeId, healthState, notes) {
        try {
            // 验证健康状态值范围
     ...
     */
    async getTaskTreeHealth(taskId) {
        try {
            // 获取任务信息
...
//# sourceMappingURL=treeHealthService.js.map