...
import { getTrees, getTreeById, createTree, updateTree, deleteTree, growTree, bindTaskToTree, unbindTaskFromTree } from '../controllers/treeController.js';
import { getTreeHealth, updateTreeHealth, batchUpdateTreesHealth } from '../controllers/treeHealthController.js';
const router = Router();
// 获取所有树木
router.get('/', getTrees);
// 获取单个树木
